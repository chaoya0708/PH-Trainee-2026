...
req = urllib.request.Request(f"{url}?role=trainee&traineeId=diane", method='POST', headers={'Content-Type': 'text/plain'})
data = json.dumps({'action': 'getInitData', 'role': 'trainee', 'traineeId': 'diane'}).encode('utf-8')
