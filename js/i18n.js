...
const I18N = {
  en: {
    ...
    loginGuest:        'Rotation Department Evaluation',
    roleMentorName:    'Program Mentor',
    roleTraineeName:   'Trainee',
    roleAssessorName:  'Rotation Department Evaluation',
    ...
    tabAnalytics:  'Progress Overview',
    tabResources:  'Learning Resource',
    resourceWarningTitle: 'STRICT CONFIDENTIALITY NOTICE',
    resourceWarningDesc: 'The following materials are strictly for internal training purposes and are considered highly confidential company assets. Any unauthorized distribution, screenshots, modification, reproduction, or commercial use is <strong>strictly prohibited</strong>.',

    // Dashboard
    weeklySchedule:     'Rotation Schedule',
    todayObjective:     "Today's Learning Objective",
    rotationDept:       'Department',
    ...
    statusReviewed:     'Mentor Confirmed',
    ...
    // Analytics
    analyticsTitle:         'Learning Progress Overview',
    ...
    lblCompetency1:       'Proactive Learning & Questioning',
    lblCompetency2:       'Observation Skills',
    lblCompetency3:       'Communication & Interaction',
    lblCompetency4:       'Adaptability',
    lblCompetency5:       'Engagement & Cooperation',
  ...
  zh: {
    ...
    resourceWarningDesc: '以下資料僅供本培訓計畫內部使用，屬於公司機密與重要資產。<strong>嚴禁</strong>以任何形式外流、截圖、修改、散布或作為商業用途。',
    ...
    lblGrade:             '站別最終考核等第',
    lblCompetency1:       '主動學習與發問',
    lblCompetency2:       '現場觀察力',
    lblCompetency3:       '溝通與互動',
    lblCompetency4:       '環境適應力',
    lblCompetency5:       '實作與配合度',
