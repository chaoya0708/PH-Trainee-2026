...
const I18N = {
  en: {
    ...
    lblPhoto:       'Photo / Report (Google Drive share link – optional)',
    ...
    lblCompetency1:       'Operations & SOP Compliance',
    lblCompetency2:       'Problem Solving & Analysis',
    lblCompetency3:       'Actionable Innovation & Proposals',
    lblCompetency4:       'Communication & Professional Attitude',
  ...
  zh: {
    ...
    lblPhoto:       '照片或報告檔案（Google Drive 分享連結 – 選填）',
    ...
    lblGrade:             '站別最終考核等第',
    lblCompetency1:       'SOP 規範與現場操作',
    lblCompetency2:       '現場分析與問題解決',
    lblCompetency3:       '在地化改善與提案力',
    lblCompetency4:       '溝通協調與專業態度',
